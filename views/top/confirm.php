    ...
    <div class="col-auto">
        ...
        <div class="form-inline">
            <form name="form1" method="post" action="">
                <input class="btn btn-secondary btn-block" name="back" type="submit" value="戻る">
            </form>
            <form name="form2" method="post" action="<?php echo BASEPATH ?>index.php/top/register/done">
                <input class="btn btn-primary btn-block" name="next" type="submit" value="次へ">
            </form>
        </div>
    </div>
</div>
